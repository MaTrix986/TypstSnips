Typst snnipets for [HyperSnips for Math](https://marketplace.visualstudio.com/items?itemName=OrangeX4.hsnips) & Obsidian([Latex Suite](https://github.com/artisticat1/obsidian-latex-suite))
